...
cd "/home/level-002" && \
  gcc -z execstack -fomit-frame-pointer -fno-stack-protector -z norelro -D_FORTIFY_SOURCE=0 -std=c1x -Wall -Wextra --pedantic "hellobof.c" -o "hellobof.elf" && \
  rm "hellobof.c"

[[ -z $(id -u "level-003" 2>/dev/null) ]] && manage-levels create_lvl 3
cp "${_local_challenges_dir}/goodbad/goodbad.elf" "/home/level-003"
cp "${_local_challenges_dir}/goodbad/goodbad.c" "/home/level-003"
cd "/home/level-003" && \
  gcc -z execstack -fomit-frame-pointer -fno-stack-protector -z norelro -D_FORTIFY_SOURCE=0 -std=c1x -Wall -Wextra --pedantic "goodbad.c" -o "goodbad-notworking.elf" && \
  rm "goodbad.c"
